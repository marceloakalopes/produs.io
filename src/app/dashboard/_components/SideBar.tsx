...
const SideBar = ({ user }: { user: User }) => {
  ...
  return (
    <div
      className={`relative block flex-col h-full w-80 min-w-72 text-center items-center py-5 px-3 border border-gray-200 bg-[#f8f8f9] ${
        loaded
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 flex flex-col w-full p-5 items-center">
        ...
        <Button variant='outline' className="select-none w-full transition-all duration-300 ease-in-out transform active:scale-95" onClick={() => signout}>Sair</Button>
