...
export default function LoginForm() {
  ...
  return (
    <div
      className={`h-screen flex flex-col items-center justify-center max-md:h-full transition-opacity duration-300 ${
    ...
    >
      ...
      <div className="flex max-w-96 flex-col justify-center gap-5 max-md:max-w-80 max-md:py-10 ">
        ...
        <form className="flex flex-col gap-5">
          ...
          <button
            className="bg-black rounded-xl font-medium text-white p-4 hover:bg-gray-800 transition-all duration-150 ease-in-out transform active:scale-95 w-full"
            formAction={login}
        ...
        <div className="flex gap-1 justify-center my-5 max-md:flex-col max-md:items-center">
